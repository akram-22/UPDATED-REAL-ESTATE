...
import { Save, CheckCircle2, ArrowLeft, Eye } from "lucide-react"
import { AdminShell } from "@/components/admin/admin-shell"
import { getArticle, createArticle, updateArticle } from "@/lib/db"
        ...
        <div className="lg:col-span-2 flex flex-col gap-5">
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Field label="Contenu de l'article" value={form.content} onChange={(v) => set("content", v)} multiline rows={16} placeholder="Rédigez votre article ici..." hint="Écrivez votre contenu. Les sauts de ligne sont préservés." />
            </div>
          </div>
