          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              {recentLeads.length === 0 ? (
                <div className="px-5 py-10 text-center text-muted-foreground text-sm">Aucun lead pour le moment.<br />Ils apparaîtront ici après soumission du formulaire.</div>
              ) : (
