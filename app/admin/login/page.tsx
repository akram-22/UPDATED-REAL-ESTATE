    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "16px", backgroundColor: "#0a1628", backgroundImage: "repeating-linear-gradient(0deg,transparent,transparent 39px,rgba(201,168,76,0.05) 39px,rgba(201,168,76,0.05) 40px),repeating-linear-gradient(90deg,transparent,transparent 39px,rgba(201,168,76,0.05) 39px,rgba(201,168,76,0.05) 40px)" }}>
      <div style={{ width: "100%", maxWidth: "380px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "32px", fontWeight: "700", color: "#ffffff", letterSpacing: "8px" }}>CHABANO</div>
          ...
          <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "8px", color: "rgba(255,255,255,0.3)", letterSpacing: "3px", marginTop: "6px" }}>ADMINISTRATION</div>
        </div>
        ...
        <div style={{ backgroundColor: "#ffffff", borderRadius: "8px", padding: "36px", boxShadow: "0 25px 60px rgba(0,0,0,0.4)", borderTop: "3px solid var(--gold)" }}>
          <h1 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "18px", fontWeight: "700", color: "#0a1628", marginBottom: "4px" }}>Connexion</h1>
          <p style={{ color: "#9ca3af", fontSize: "13px", marginBottom: "28px" }}>Accès réservé à l&apos;administrateur</p>

          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div>
              <label style={{ display: "block", fontSize: "11px", fontWeight: "600", color: "#0a1628", marginBottom: "6px", letterSpacing: "2px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>IDENTIFIANT</label>
            ...
            <div>
              <label style={{ display: "block", fontSize: "11px", fontWeight: "600", color: "#0a1628", marginBottom: "6px", letterSpacing: "2px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>MOT DE PASSE</label>
              <div style={{ position: "relative" }}>
            ...
            <button type="button" onClick={handleSubmit} disabled={loading}
              style={{ backgroundColor: "#0a1628", color: "#ffffff", border: "none", borderRadius: "6px", padding: "14px", fontSize: "14px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "2px", cursor: loading ? "not-allowed" : "pointer", opacity: loading ? 0.7 : 1, marginTop: "4px", borderBottom: "2px solid var(--gold)" }}>
              {loading ? "CONNEXION..." : "SE CONNECTER"}
            </button>
          </div>
        </div>

        <div style={{ textAlign: "center", marginTop: "20px", color: "rgba(255,255,255,0.2)", fontSize: "11px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "2px" }}>
