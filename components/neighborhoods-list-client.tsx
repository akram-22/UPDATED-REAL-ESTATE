    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f9fafb" }}>
      <header style={{ backgroundColor: "#0a1628", borderBottom: "1px solid rgba(201,168,76,0.2)", position: "sticky", top: 0, zIndex: 50 }}>
        ...
        <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 20px", height: "60px", display: "flex", alignItems: "center", gap: "16px" }}>
          <a href="/" style={{ color: "rgba(255,255,255,0.7)", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "13px", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px" }}>← Accueil</a>
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "60px 20px 80px" }}>
        <div style={{ textAlign: "center", marginBottom: "52px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
            ...
            <span style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "5px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>ORAN — ALGÉRIE</span>
            <div style={{ width: "32px", height: "1px", backgroundColor: "var(--gold)" }} />
          </div>
          ...
          {items.map((n) => (
            <div key={n.slug} onClick={() => router.push(`/quartiers/${n.slug}`)}
              ...
              <div style={{ aspectRatio: "16/9", backgroundColor: "#0a1628", position: "relative" }}>
                ...
                <div style={{ position: "absolute", bottom: "16px", left: "16px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "20px", fontWeight: 700, color: "white" }}>{n.name}</div>
              </div>
              <div style={{ padding: "16px" }}>
                ...
                <span style={{ color: "var(--gold)", fontSize: "13px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>Explorer ce quartier →</span>
              </div>
            </div>
          ))}
        </div>
