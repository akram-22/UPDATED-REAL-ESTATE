      ...
      <section className="relative py-28 md:py-36 overflow-hidden" style={{ backgroundColor: "#0a1628" }}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-5 md:px-8 text-center">
          <div className="inline-flex items-center gap-2 mb-6">
            ...
            <span style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "5px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{finalCta.label.toUpperCase()}</span>
            <div className="w-8 h-px" style={{ backgroundColor: "var(--gold)" }} />
          </div>

          <h2 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "clamp(36px, 5vw, 56px)", fontWeight: "800", color: "#ffffff", lineHeight: "1.15", letterSpacing: "-0.03em", marginBottom: "24px" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            ...
            <a href={`tel:+${contact.whatsappNumber}`}
              style={{ display: "inline-flex", alignItems: "center", gap: "8px", border: "1px solid rgba(201,168,76,0.4)", color: "rgba(255,255,255,0.8)", padding: "14px 40px", borderRadius: "6px", fontSize: "15px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px", textDecoration: "none", transition: "all 0.2s", width: "100%" }}
        ...
        <div className="max-w-6xl mx-auto px-5 md:px-8 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="text-center md:text-left">
              <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "24px", fontWeight: "700", color: "#ffffff", letterSpacing: "6px" }}>CHABANO</div>
              <div style={{ height: "1px", background: "var(--gold)", margin: "6px 0", opacity: 0.6 }} />
              <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "9px", color: "var(--gold)", letterSpacing: "5px" }}>OWNING WAHRAN</div>
              <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "8px", color: "rgba(255,255,255,0.3)", letterSpacing: "2px", marginTop: "8px" }}>IMMOBILIER DE PRESTIGE · ORAN</div>
            </div>

            {/* Nav links */}
            <nav className="flex flex-wrap justify-center gap-6">
              {[["Services","#services"],["Biens","#properties"],["À propos","#about"],["Contact","#contact"]].map(([label, href]) => (
                <a key={href} href={href} style={{ color: "rgba(255,255,255,0.4)", fontSize: "12px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "2px", textDecoration: "none", transition: "color 0.2s" }}
          ...
          <div style={{ marginTop: "40px", paddingTop: "20px", borderTop: "1px solid rgba(255,255,255,0.05)", textAlign: "center", color: "rgba(255,255,255,0.2)", fontSize: "11px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "2px" }}>
