      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "100px 20px 80px" }}>
        <div style={{ textAlign: "center", marginBottom: "44px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
            ...
            <span style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "5px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>BLOG & ACTUALITÉS</span>
            <div style={{ width: "32px", height: "1px", backgroundColor: "var(--gold)" }} />
          </div>
          <h1 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "42px", fontWeight: "700", color: "#0a1628" }}>
        ...
        <div style={{ position: "relative", marginBottom: "20px" }}>
          ...
          <input
            ...
            style={{ width: "100%", padding: "13px 16px 13px 44px", borderRadius: "10px", border: "1px solid #e5e7eb", backgroundColor: "white", fontSize: "14px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", outline: "none" }}
          />
          {query && (
        ...
        {categories.length > 0 && (
          <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "12px" }}>
            <button onClick={() => setActiveCategory(null)}
              style={{ fontSize: "12px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", padding: "6px 14px", borderRadius: "100px", border: activeCategory === null ? "1px solid #0a1628" : "1px solid #e5e7eb", backgroundColor: activeCategory === null ? "#0a1628" : "white", color: activeCategory === null ? "white" : "#6b7280", cursor: "pointer" }}>
              Toutes catégories
            </button>
            {categories.map((c) => (
              <button key={c.id} onClick={() => setActiveCategory(c.id === activeCategory ? null : c.id)}
                style={{ fontSize: "12px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", padding: "6px 14px", borderRadius: "100px", border: activeCategory === c.id ? "1px solid #0a1628" : "1px solid #e5e7eb", backgroundColor: activeCategory === c.id ? "#0a1628" : "white", color: activeCategory === c.id ? "white" : "#6b7280", cursor: "pointer" }}>
                {c.name}
              </button>
            ))}
          </div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "40px" }}>
            {allTags.map((t) => (
              <button key={t} onClick={() => setActiveTag(t === activeTag ? null : t)}
                style={{ fontSize: "11px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", padding: "4px 10px", borderRadius: "100px", border: activeTag === t ? "1px solid var(--gold)" : "1px solid #e5e7eb", backgroundColor: activeTag === t ? "rgba(201,168,76,0.12)" : "transparent", color: activeTag === t ? "var(--gold)" : "#9ca3af", cursor: "pointer" }}>
                #{t}
              </button>
            ))}
          </div>
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign: "center", padding: "60px 0", color: "#9ca3af", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>
              ...
              <div key={article.id} onClick={() => router.push(`/blog/${article.slug}`)}
                ...
                <div style={{ padding: "24px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
                    <span style={{ fontSize: "11px", color: "var(--gold)", letterSpacing: "3px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>
                  ...
                  <h2 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "22px", fontWeight: "700", color: "#0a1628", marginBottom: "10px", lineHeight: "1.3" }}>{article.title}</h2>
                  <p style={{ color: "#6b7280", fontSize: "14px", lineHeight: "1.7", marginBottom: "16px" }}>{article.excerpt}</p>
                  <span style={{ color: "var(--gold)", fontSize: "13px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px" }}>Lire l'article →</span>
                </div>
              </div>
            ))}
          </div>
