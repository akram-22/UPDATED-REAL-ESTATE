      ...
      <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 20px" }}>
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
            ...
            <span style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "5px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{services.sectionLabel.toUpperCase()}</span>
            <div style={{ width: "32px", height: "1px", backgroundColor: "var(--gold)" }} />
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: "20px" }}>
          {list.map(({ data, icon: Icon, link, accent }) => (
            <div key={data.tag} style={{
              ...
              <span style={{ display: "inline-block", fontSize: "10px", fontWeight: "700", letterSpacing: "3px", padding: "3px 12px", borderRadius: "100px", marginBottom: "20px", width: "fit-content", backgroundColor: accent ? "rgba(201,168,76,0.2)" : "rgba(201,168,76,0.1)", color: "var(--gold)", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{data.tag.toUpperCase()}</span>
              ...
              <h3 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "18px", fontWeight: "700", marginBottom: "12px", color: accent ? "#ffffff" : "#0a1628" }}>{data.title}</h3>
              ...
              <a href={link} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "13px", fontWeight: "600", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px", color: "var(--gold)", textDecoration: "none" }}>
