    ...
    <div onClick={() => router.push(`/properties/${property.id}`)}
      ...
      <div style={{ position: "relative", aspectRatio: "4/3", backgroundColor: "#0a1628", overflow: "hidden" }}>
        {images.length > 0
          ...
          : <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "rgba(255,255,255,0.3)", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "13px" }}>Pas de photo</div>
        }
        <span style={{ position: "absolute", top: "12px", left: "12px", backgroundColor: "#c9a84c", color: "#0a1628", fontSize: "10px", fontWeight: "700", padding: "3px 10px", borderRadius: "100px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px" }}>{property.badge}</span>
        ...
        {images.length > 1 && (
          <div style={{ position: "absolute", bottom: "10px", left: "10px", backgroundColor: "rgba(0,0,0,0.5)", color: "white", fontSize: "10px", padding: "2px 8px", borderRadius: "100px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>
      ...
      <div style={{ padding: "16px" }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "8px", marginBottom: "6px" }}>
          <h3 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontWeight: "700", color: "#0a1628", fontSize: "15px", lineHeight: "1.3" }}>{property.title}</h3>
          <span style={{ fontSize: "11px", fontWeight: "700", color: "#0a1628", backgroundColor: "rgba(201,168,76,0.12)", border: "1px solid rgba(201,168,76,0.3)", padding: "2px 8px", borderRadius: "4px", flexShrink: 0, fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{property.type}</span>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "12px", borderTop: "1px solid #f3f4f6" }}>
          <span style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "18px", fontWeight: "700", color: "var(--gold)" }}>{property.price}</span>
          <span style={{ fontSize: "12px", color: "var(--gold)", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px", display: "flex", alignItems: "center", gap: "4px" }}>
            Voir détails →
          </span>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 20px" }}>
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
            ...
            <span style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "5px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>BIENS DISPONIBLES</span>
            <div style={{ width: "32px", height: "1px", backgroundColor: "var(--gold)" }} />
          </div>
          <h2 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "clamp(28px,4vw,42px)", fontWeight: "800", color: "#0a1628", marginBottom: "12px", letterSpacing: "-0.03em" }}>
