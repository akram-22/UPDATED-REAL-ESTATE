...
import { LayoutDashboard, Building2, MessageSquare, FileText, LogOut, X, TrendingUp } from "lucide-react"
    ...
    <div className="flex flex-col h-full" style={{ backgroundColor: "#0a1628" }}>
          ...
          return (
            <Link key={item.href} href={item.href} onClick={onClose}
              style={{
                ...
                fontSize: "13px", fontFamily: "Georgia, serif", letterSpacing: "1px",
      ...
      <div style={{ padding: "12px" }}>
        <button onClick={logout}
          style={{ display: "flex", alignItems: "center", gap: "10px", width: "100%", padding: "10px 12px", borderRadius: "6px", fontSize: "13px", fontFamily: "Georgia, serif", letterSpacing: "1px", color: "rgba(255,255,255,0.3)", background: "none", border: "none", cursor: "pointer" }}>
