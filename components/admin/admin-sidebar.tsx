    ...
    <div className="flex flex-col h-full" style={{ backgroundColor: "#0a1628" }}>
      ...
      <div style={{ padding: "12px" }}>
        <button onClick={logout}
          style={{ display: "flex", alignItems: "center", gap: "10px", width: "100%", padding: "10px 12px", borderRadius: "6px", fontSize: "13px", fontFamily: "Georgia, serif", letterSpacing: "1px", color: "rgba(255,255,255,0.3)", background: "none", border: "none", cursor: "pointer", transition: "color 0.15s" }}>
