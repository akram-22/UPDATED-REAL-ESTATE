...
import { LayoutDashboard, Building2, MessageSquare, FileText, LogOut, X, TrendingUp, Search, BookOpen, ArrowRight, HelpCircle, MapPin, BarChart3, Activity } from "lucide-react"
...
const NAV = [
  ...
  { label: "SEO Local & GA", href: "/admin/gbp", icon: BarChart3 },
  ...
  return (
    <div className="flex flex-col h-full" style={{ backgroundColor: "#0a1628" }}>
      ...
      <div style={{ padding: "20px", borderBottom: "1px solid rgba(201,168,76,0.15)" }} className="flex items-center justify-between">
        <div>
          <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "18px", fontWeight: "700", color: "#ffffff", letterSpacing: "5px" }}>CHABANO</div>
          <div style={{ height: "1px", background: "var(--gold)", margin: "4px 0", opacity: 0.6, width: "80px" }} />
          <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "7px", color: "var(--gold)", letterSpacing: "3px" }}>OWNING WAHRAN</div>
        </div>
        {onClose && (
          ...
          return (
            <Link key={item.href} href={item.href} onClick={onClose}
              style={{
                ...
                fontSize: "13px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "0.5px",
      ...
      <div style={{ padding: "12px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <button onClick={logout}
          style={{ display: "flex", alignItems: "center", gap: "10px", width: "100%", padding: "9px 12px", borderRadius: "6px", fontSize: "13px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", color: "rgba(255,255,255,0.3)", background: "none", border: "none", cursor: "pointer" }}>
