...
export function PromotionDetailClient() {
  ...
  if (!promo) return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "16px" }}>
      <p style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", color: "#6b7280" }}>Promotion introuvable</p>
      <button onClick={() => router.push("/#promotions")} style={{ display: "flex", alignItems: "center", gap: "8px", backgroundColor: "#0a1628", color: "white", border: "none", borderRadius: "6px", padding: "10px 20px", cursor: "pointer", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f9fafb" }}>
      <header style={{ backgroundColor: "#0a1628", borderBottom: "1px solid rgba(201,168,76,0.2)", position: "sticky", top: 0, zIndex: 50 }}>
        ...
        <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 20px", height: "60px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <button onClick={() => router.push("/")} style={{ display: "flex", alignItems: "center", gap: "8px", color: "rgba(255,255,255,0.7)", background: "none", border: "none", cursor: "pointer", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "13px" }}>
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "32px 20px 80px" }}>
        <div style={{ marginBottom: "24px" }}>
          <Breadcrumb items={[{ name: "Promotions", path: "/#promotions" }, { name: promo.title, path: `/promotions/${promo.id}` }]} />
        </div>
        {/* Hero image */}
        <div style={{ position: "relative", borderRadius: "12px", overflow: "hidden", aspectRatio: "16/9", backgroundColor: "#0a1628", marginBottom: "24px" }}>
          {showVideo && promo.video_url ? (
            ...
            <img src={images[imgIdx]} alt={`${promo.title} — ${promo.location}`} loading="eager" decoding="async" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          ) : (
            <div style={{ width: "100%", height: "100%", background: "linear-gradient(135deg, #0a1628, #162d52)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <div style={{ textAlign: "center" }}>
                ...
                <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "14px", color: "rgba(255,255,255,0.4)", marginTop: "12px", letterSpacing: "3px" }}>PROJET IMMOBILIER</div>
              </div>
            </div>
          )}
          <span style={{ position: "absolute", top: "16px", left: "16px", backgroundColor: "#c9a84c", color: "#0a1628", fontSize: "11px", fontWeight: "700", padding: "4px 14px", borderRadius: "100px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{promo.badge || "NOUVEAU PROJET"}</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1.5fr) minmax(0,1fr)", gap: "24px", alignItems: "start" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "24px", border: "1px solid #e5e7eb" }}>
              <h1 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "28px", fontWeight: "700", color: "#0a1628", marginBottom: "8px" }}>{promo.title}</h1>
              ...
              {(promo.price_from || promo.price_to) && (
                <div style={{ padding: "16px", backgroundColor: "rgba(201,168,76,0.08)", borderRadius: "8px", borderLeft: "3px solid var(--gold)" }}>
                  <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "22px", fontWeight: "700", color: "var(--gold)" }}>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "24px", border: "1px solid #e5e7eb" }}>
              <h2 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "16px", fontWeight: "700", color: "#0a1628", marginBottom: "16px", letterSpacing: "1px" }}>INFORMATIONS DU PROJET</h2>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                {[
                  ...
                  <div key={item.label} style={{ backgroundColor: "#f9fafb", borderRadius: "8px", padding: "12px", borderLeft: "3px solid var(--gold)" }}>
                    <div style={{ fontSize: "11px", color: "#9ca3af", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px", marginBottom: "4px" }}>{item.label.toUpperCase()}</div>
                    <div style={{ fontSize: "14px", fontWeight: "600", color: "#0a1628", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{item.value}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            {promo.types_available && promo.types_available.length > 0 && (
              <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "24px", border: "1px solid #e5e7eb" }}>
                <h2 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "16px", fontWeight: "700", color: "#0a1628", marginBottom: "16px", letterSpacing: "1px" }}>TYPES DISPONIBLES</h2>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                  {promo.types_available.map((t) => (
                    <span key={t} style={{ backgroundColor: "rgba(201,168,76,0.1)", color: "#0a1628", border: "1px solid rgba(201,168,76,0.3)", padding: "8px 16px", borderRadius: "100px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "14px", fontWeight: "600" }}>{t}</span>
                  ))}
                </div>
              </div>
            )}
            ...
            {promo.description && (
              <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "24px", border: "1px solid #e5e7eb" }}>
                <h2 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "16px", fontWeight: "700", color: "#0a1628", marginBottom: "16px", letterSpacing: "1px" }}>DESCRIPTION DU PROJET</h2>
            ...
            {promo.features && promo.features.length > 0 && (
              <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "24px", border: "1px solid #e5e7eb" }}>
                <h2 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "16px", fontWeight: "700", color: "#0a1628", marginBottom: "16px", letterSpacing: "1px" }}>PRESTATIONS & ÉQUIPEMENTS</h2>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                  {promo.features.map((f) => (
                    <span key={f} style={{ display: "inline-flex", alignItems: "center", gap: "6px", backgroundColor: "rgba(201,168,76,0.08)", color: "#0a1628", border: "1px solid rgba(201,168,76,0.3)", padding: "6px 14px", borderRadius: "100px", fontSize: "13px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>✓ {f}</span>
                  ))}
                </div>
              </div>
            )}
          ...
          <div style={{ position: "sticky", top: "80px" }}>
            <div style={{ backgroundColor: "#0a1628", borderRadius: "12px", padding: "24px", borderTop: "3px solid var(--gold)" }}>
              <div style={{ textAlign: "center", marginBottom: "20px" }}>
                ...
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "13px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", lineHeight: "1.6" }}>Intéressé par ce projet ? Contactez Chabane pour plus d&apos;informations.</p>
              </div>
              ...
              <a href={`tel:+${content.contact.whatsappNumber}`} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", border: "1px solid rgba(201,168,76,0.3)", color: "rgba(255,255,255,0.7)", padding: "12px", borderRadius: "6px", fontSize: "13px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px", textDecoration: "none" }}>
