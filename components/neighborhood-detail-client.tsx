  ...
  return (
    <div onClick={() => router.push(`/properties/${property.id}`)}
      ...
      <div style={{ aspectRatio: "4/3", backgroundColor: "#0a1628" }}>
        {img ? <img src={img} alt={property.title} loading="lazy" decoding="async" style={{ width: "100%", height: "100%", objectFit: "cover" }} /> : <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "rgba(255,255,255,0.3)", fontFamily: "Georgia, serif", fontSize: "12px" }}>Pas de photo</div>}
      </div>
      <div style={{ padding: "14px" }}>
        <div style={{ fontFamily: "Georgia, serif", fontSize: "14px", fontWeight: 700, color: "#0a1628", marginBottom: "4px" }}>{property.title}</div>
        <div style={{ fontSize: "12px", color: "#9ca3af", marginBottom: "8px" }}>{property.surface}{property.rooms ? ` · ${property.rooms} pcs` : ""}</div>
        <div style={{ fontFamily: "Georgia, serif", fontSize: "16px", fontWeight: 700, color: "var(--gold)" }}>{property.price}</div>
      </div>
    </div>
  )
}
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f9fafb" }}>
      <header style={{ backgroundColor: "#0a1628", borderBottom: "1px solid rgba(201,168,76,0.2)", position: "sticky", top: 0, zIndex: 50 }}>
        ...
        <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 20px", height: "60px", display: "flex", alignItems: "center", gap: "16px" }}>
          <a href="/" style={{ color: "rgba(255,255,255,0.7)", fontFamily: "Georgia, serif", fontSize: "13px", textDecoration: "none" }}>← Accueil</a>
      ...
      <div style={{ position: "relative", height: "320px", backgroundColor: "#0a1628", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: "32px", maxWidth: "800px", margin: "0 auto", width: "100%" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
            ...
            <span style={{ color: "var(--gold)", fontSize: "10px", letterSpacing: "4px", fontFamily: "Georgia, serif" }}>QUARTIER · ORAN</span>
          </div>
          <h1 style={{ fontFamily: "Georgia, serif", fontSize: "40px", fontWeight: 700, color: "white", lineHeight: "1.2" }}>Immobilier à {name}</h1>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 20px 80px" }}>
        ...
        {intro && (
          <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "28px", border: "1px solid #e5e7eb", marginBottom: "24px" }}>
            <h2 style={{ fontFamily: "Georgia, serif", fontSize: "20px", fontWeight: 700, color: "#0a1628", marginBottom: "12px" }}>Le quartier {name}</h2>
        ...
        {amenities.length > 0 && (
          <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "28px", border: "1px solid #e5e7eb", marginBottom: "24px" }}>
            <h2 style={{ fontFamily: "Georgia, serif", fontSize: "18px", fontWeight: 700, color: "#0a1628", marginBottom: "16px" }}>Équipements à proximité</h2>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
              {amenities.map((a) => (
                <span key={a} style={{ display: "inline-flex", alignItems: "center", gap: "6px", backgroundColor: "rgba(201,168,76,0.08)", color: "#0a1628", border: "1px solid rgba(201,168,76,0.25)", padding: "7px 14px", borderRadius: "100px", fontSize: "13px", fontFamily: "Georgia, serif" }}>✓ {a}</span>
              ))}
            </div>
          </div>
        )}
        ...
        <div style={{ marginBottom: "24px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "10px", marginBottom: "20px" }}>
            <div style={{ width: "24px", height: "1px", backgroundColor: "var(--gold)" }} />
            <span style={{ color: "var(--gold)", fontSize: "10px", letterSpacing: "4px", fontFamily: "Georgia, serif" }}>BIENS DISPONIBLES</span>
          </div>
          {properties.length === 0 ? (
            <div style={{ textAlign: "center", padding: "40px", backgroundColor: "white", borderRadius: "12px", border: "1px solid #e5e7eb" }}>
              <p style={{ color: "#9ca3af", fontFamily: "Georgia, serif" }}>Aucun bien disponible dans ce quartier pour le moment.</p>
              <a href={`https://wa.me/213541029014?text=Bonjour Chabane, je cherche un bien à ${name}, Oran.`} target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", marginTop: "16px", backgroundColor: "#0a1628", color: "white", padding: "10px 24px", borderRadius: "6px", fontFamily: "Georgia, serif", fontSize: "13px", textDecoration: "none" }}>
        ...
        <div style={{ backgroundColor: "#0a1628", borderRadius: "12px", padding: "28px", borderTop: "3px solid var(--gold)", textAlign: "center", marginTop: "32px" }}>
          <p style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "4px", fontFamily: "Georgia, serif", marginBottom: "8px" }}>VOTRE EXPERT LOCAL À {name.toUpperCase()}</p>
          <p style={{ color: "rgba(255,255,255,0.8)", fontFamily: "Georgia, serif", fontSize: "18px", marginBottom: "20px" }}>Vous cherchez ou vendez un bien dans ce quartier ?</p>
