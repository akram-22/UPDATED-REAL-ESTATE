        ...
        return (
          <div key={section.id} style={{ marginBottom: "8px" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
              ...
              <span style={{ color: "var(--gold)", fontSize: "10px", letterSpacing: "4px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>FAQ</span>
            </div>
            <h2 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "24px", fontWeight: 700, color: "#0a1628", marginBottom: section.description ? "8px" : "16px" }}>
              {section.title}
            </h2>
            {section.description && (
