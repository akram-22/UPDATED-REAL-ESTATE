    ...
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", backgroundColor: "#0a1628" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: "900px", margin: "0 auto", padding: "100px 20px 60px", textAlign: "center" }}>
        ...
        <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(201,168,76,0.4)", borderRadius: "100px", padding: "6px 18px", marginBottom: "32px" }}>
          ...
          <span style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "4px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{hero.badge.toUpperCase()}</span>
        </div>

        {/* Main headline */}
        <h1 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "clamp(32px,5vw,64px)", fontWeight: "800", color: "#ffffff", lineHeight: "1.15", letterSpacing: "-0.03em", marginBottom: "24px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "40px", marginBottom: "48px" }}>
          {[
            ...
            <div key={s.label} style={{ textAlign: "center" }}>
              <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "36px", fontWeight: "700", color: "var(--gold)" }}>{s.value}</div>
              <div style={{ color: "rgba(255,255,255,0.5)", fontSize: "11px", letterSpacing: "2px", marginTop: "4px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{s.label.toUpperCase()}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "center", gap: "16px" }}>
          ...
          <a href="#properties"
            style={{ display: "inline-flex", alignItems: "center", gap: "8px", border: "1px solid rgba(255,255,255,0.3)", color: "rgba(255,255,255,0.85)", padding: "14px 32px", borderRadius: "6px", fontSize: "15px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px", textDecoration: "none", transition: "all 0.2s" }}>
        ...
        <div style={{ marginTop: "60px", display: "flex", flexDirection: "column", alignItems: "center", gap: "8px", color: "rgba(255,255,255,0.25)", animation: "bounce 2s infinite" }}>
          <span style={{ fontSize: "10px", letterSpacing: "3px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>DÉCOUVRIR</span>
          <ArrowDown size={16} />
        </div>
      </div>
    </section>
