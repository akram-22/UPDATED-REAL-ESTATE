      ...
      <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 20px" }}>
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
            ...
            <span style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "5px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{content.promotions.sectionLabel.toUpperCase()}</span>
            <div style={{ width: "32px", height: "1px", backgroundColor: "var(--gold)" }} />
          </div>
          ...
          {promotions.map((promo) => (
            <div key={promo.id} onClick={() => router.push(`/promotions/${promo.id}`)}
                ...
                {promo.images && promo.images[0]
                  ...
                  : <div style={{ width: "100%", height: "100%", background: "linear-gradient(135deg, #0a1628, #162d52)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <div style={{ textAlign: "center" }}>
                        <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "32px", color: "rgba(201,168,76,0.3)" }}>🏗</div>
                        <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "12px", color: "rgba(255,255,255,0.3)", marginTop: "8px", letterSpacing: "2px" }}>PROJET IMMOBILIER</div>
                      </div>
                    </div>
                }
                <span style={{ position: "absolute", top: "12px", left: "12px", backgroundColor: "#c9a84c", color: "#0a1628", fontSize: "10px", fontWeight: "700", padding: "3px 10px", borderRadius: "100px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", letterSpacing: "1px" }}>{promo.badge || "NOUVEAU"}</span>
              ...
              <div style={{ padding: "20px" }}>
                <h3 style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "18px", fontWeight: "700", color: "#0a1628", marginBottom: "4px" }}>{promo.title}</h3>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "12px" }}>
                  {promo.types_available && promo.types_available.map((t) => (
                    <span key={t} style={{ fontSize: "11px", backgroundColor: "rgba(201,168,76,0.1)", color: "#0a1628", border: "1px solid rgba(201,168,76,0.3)", padding: "2px 10px", borderRadius: "100px", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif" }}>{t}</span>
                  ))}
                </div>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "12px", borderTop: "1px solid #f3f4f6" }}>
                  <div>
                    {promo.price_from && (
                      <div style={{ fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", fontSize: "16px", fontWeight: "700", color: "var(--gold)" }}>
                  ...
                  <span style={{ fontSize: "12px", color: "var(--gold)", fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif", display: "flex", alignItems: "center", gap: "4px" }}>
