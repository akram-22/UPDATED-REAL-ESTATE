...
export function AboutSection() {
  ...
  const WHATSAPP_LINK = `https://wa.me/${contact.whatsappNumber}?text=Bonjour%20Chabane%2C%20je%20souhaite%20en%20savoir%20plus%20sur%20vos%20services.`
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-navy mb-6 leading-tight text-balance">
              {about.headline}
              <br />
              <span className="text-gold">{about.subheadline}</span>
            </h2>
